...
function $_GET(args,set_to) {
    ...
    var hash = window.location.hash.slice(1,Infinity);
    ...
    //return other functions of JSGET
        ...
        return {
            ...
            'length' : function () { return window.location.hash.split("=").length -1 }  //returns the length of arguments. to be used with arguumentList to loop
        }
    }
...
var nxt = {
  ...
  openMenu : function(call) {
    ...
    $$('body')[0].classList.add("NineDotMenuTransition");
      setTimeout(function() {
        window.location.href=call+"rtsmenu.html"
      },550)
  },
